...
function MultiselectDropdown(options) {
  ...
  document.querySelectorAll("select[multiple]").forEach((el, k) => {
    ...
    var search = newEl('input', { class: ['multiselect-dropdown-search'].concat([config.searchInput?.class ?? 'form-control']), style: { width: '100%', height: '35px', padding: '10px' }, placeholder: 'search' });
...
window.onload= function (){
  ...
  console.log( window.MultiselectDropdownOptions)
};